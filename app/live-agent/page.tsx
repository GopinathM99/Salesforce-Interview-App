  ...
  return (
    <div className="grid">
      <div className="card" style={{ gridColumn: "1 / -1" }}>
        ...
        <p>
          Practice live mock interviews with an AI interviewer using voice or text. We will
          add the realtime session experience in phases.
        </p>
        ...
        <div style={{ marginTop: 20 }}>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            {messages.length === 0 && (
              <p className="muted">Start a session and speak or type to see the transcript.</p>
            )}
