-- SQL Template for Gemini Question Generation
-- This file is used by lib/followUpPromptTemplate.ts to generate the Gemini follow-up prompt.
-- Changes to this file are automatically synced via scripts/sync-sql-template.js
-- Run: npm run sync-sql-template (or restart dev server)
